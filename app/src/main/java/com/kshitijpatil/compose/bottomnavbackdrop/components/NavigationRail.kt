...
fun NavigationRail(
    ...
    elevation: Dp = NavigationRailElevation,
 ...
 * @param selected whether this item is selected
 * @param content the content of the [NavigationRailItem] to animate [AmbientContentColor] for,
...
private fun BottomNavigationTransition(
    ...
    val animationProgress = animate(
        ...
        animSpec = NavigationRailAnimationSpec
    )
    ...
    Layout(
        {
            ...
            Box(
                Modifier
                    ...
                    .padding(vertical = NavigationRailItemVerticalPadding)
            ) { label() }
        }
...
/**
 * Padding at the top and bottom of a [NavigationRailItem]
 */
private val NavigationRailItemVerticalPadding = 12.dp